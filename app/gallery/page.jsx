...
// Gallery data runtime par fetch hogi
...
async function getGallery() {
  try {
    ...
    return json.success && Array.isArray(json.data)
      ? json.data.filter((item) => item.status === "Active")
      : [];
  } catch (err) {
        ...
        {gallery.length === 0 ? (
          ...
          <div className="rounded-3xl bg-white p-16 text-center shadow-xl">
            ...
            <p className="mt-3 text-gray-500">
              Images and videos uploaded from the admin panel will appear
              here.
            </p>
                    ...
                    {item.type === "video" ? (
                      ...
                      youtubeId ? (
                        ...
                        <iframe
                          ...
                          title={item.title || "Dew Care Hospital Video"}
                      ...
                      imageUrl ? (
                        ...
                        <img
                          src={imageUrl}
                          alt={item.title || "Dew Care Hospital Gallery"}
                          width={800}
                          height={600}
